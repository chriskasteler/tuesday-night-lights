...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    await removeTagFromMember(email, tag, MAILCHIMP_API_KEY, MAILCHIMP_AUDIENCE_ID, datacenter);
    ...
    return {
      ...
      body: JSON.stringify({ 
        success: true, 
        message: `Tag '${tag}' removed from ${email} successfully`
      })
    };
...
function removeTagFromMember(email, tag, apiKey, audienceId, datacenter) {
